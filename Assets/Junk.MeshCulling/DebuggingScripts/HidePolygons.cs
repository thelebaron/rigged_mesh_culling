...
{
    /// <summary>
    /// Set random tris alpha to white, and if the shader clips white, those faces will be invisible
    /// </summary>
    [ExecuteAlways]
    public class HidePolygons : MonoBehaviour
    {
        ...
        private int[] GetRandomTriangles()
        {
        ...
        private void HideTrianglesInShader(int[] randomTriangles)
        {
